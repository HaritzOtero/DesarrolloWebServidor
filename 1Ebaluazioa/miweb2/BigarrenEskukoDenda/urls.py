...
urlpatterns = [
    ...
    path ('authors/aldatuAuthor/<int:id>/aldatuAuthorPost/', views.aldatuAuthorPost, name='add'),
    path ('authors/aldatuAuthor/<int:id>/', views.aldatuAuthors, name='add'),
    ...
    path ('authors/ezabatuAutorea/<int:id>/', views.deleteAuthor, name='ezabatu'),
